...
\headerbox{5. Results}{name=done,span=2,column=1,below=kaitai}{ % To reduce this block to 1 column width, remove 'span=2'
	\begin{multicols}{2}
...
\headerbox{7. HiSCORE specification diagram}{name=example,column=1, span=2, below=done}{
